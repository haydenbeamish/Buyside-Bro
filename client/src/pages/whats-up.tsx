...
export default function WhatsUpPage() {
  useDocumentTitle("What's Up", "Analyst-written market wraps for US, ASX, European, and Asian markets. Get top gainers and losers, overnight recaps, and closing summaries auto-triggered on each market close on Buy Side Bro.");
